...
const Keluar = () => {
  const [suratKeluar, setSuratKeluar] = useState([
    { id: 1, nomor: '001/KLR/2023', tanggal: '2023-01-01', perihal: 'Surat Keluar 1' },
    { id: 2, nomor: '002/KLR/2023', tanggal: '2023-01-02', perihal: 'Surat Keluar 2' },
    // ...other data...
  ]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setSuratKeluar([...suratKeluar, { ...form, id: suratKeluar.length + 1 }]);
    ...
    <div className="p-8">
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-xl font-semibold">Surat Keluar</h1>
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        <h2 className="text-lg font-semibold mb-4">Tambah Surat Keluar</h2>
